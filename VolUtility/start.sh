...
sleep 5
#echo "from django.contrib.auth import get_user_model; User = get_user_model(); User.objects.create_superuser('admin', 'your_email', 'your_password" | python manage.py shell
